...
public class RestTemplateControllerTesting implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        printUtils.breakFunc();
        printUtils.print("Get all customer #11 purchased coupons by category");
        ...
        printUtils.breakFunc();
        printUtils.print("Get all customer #11 purchased coupons by max price of- 25.5");
        Coupon[] customerPurchasedCouponsByMaxPrice = restTemplate.getForObject(CUSTOMER + "/11/coupons/price/max?maxPrice=25.5", Coupon[].class);
